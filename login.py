...
def get_resource_path(relative_path):
    """Retorna o caminho correto para o arquivo, levando em consideração se estamos no ambiente empacotado"""
    try:
        # PyInstaller cria uma pasta temporária onde os arquivos são extraídos
        base_path = sys._MEIPASS
    except Exception:
        # Caso contrário, estamos no ambiente de desenvolvimento
...
def tela_login():
    ...
    # Aqui usamos a função get_resource_path para pegar o caminho correto do logo
