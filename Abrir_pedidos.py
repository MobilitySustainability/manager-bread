...
def Abrir_pedidos(container, item, tenant_id):
    ...
    ttk.Label(container, text="Listar pedidos", font=("Arial", 24, "bold"), background=cor_fundo, foreground=cor_texto).grid(row=1, column=0, columnspan=2, padx=10, pady=5, sticky="w")
